...
class CustomerProcessingOrder
{
  ...
  {
    add_action('woocommerce_email', [$this, 'disableEmails']);
    add_filter('woocommerce_order_status_pending_to_processing_notification', [$this, 'filterEmailDetails'], 10, 2);
  }

  /**
   * remove action to disbale default mail 
   */
  public function disableEmails($email_class)
  {
   ...
   */
  public function filterEmailDetails($orderId, $order)
  {
    $args = array(
      ...
      'meta_query' => array(
        array(
          'key'     => 'tamplate_name',
          'value'   => 'woocommerce_order_status_pending_to_processing_for_customer',
        ),
        array(
          'key'     => 'active_option',
          'value'   => true,
    ...
    // \MailKit\Helpers\Utils::writeLog($orderDetails);
  }
}
